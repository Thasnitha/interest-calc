    ...
    <div  style={{width:'100%',minHeight:'100vh'}} className='d-flex justify-content-center align-items-center bg-dark'>
      <div style={{width:'600px'}} className='bg-light rounded p-5'>
        ...
        <form className='mt-5'>
          ...
          {/* invalid */}
         {invalidPrinciple && <div className='fw-bolder text-danger mb-3'>
          ...
          {/* invalid */}
         {invalidRate && <div className='fw-bolder text-danger mb-3'>
            Invalid Rate!!!
          </div>}
          {/* year */}
          <div className="mb-3">
          ...
          {invalidYear && <div className='fw-bolder text-danger mb-3'>
            Invalid Year!!!
          </div>}
